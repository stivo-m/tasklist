class AppStrings {
  ...
  static const String enterListTitleText = 'Enter list title';
  static const String newTaskText = 'New task';
  static const String addDetailsText = 'Add details';
  ...
  static const String noTasksYetDescription =
      'You have not added any items to this to-do list. Press the button below to start creating an item.';
}
